...
import com.lach.weatherApp.Weather;
...
public class WeatherApi {
    ...
    private static final String API_URL_TEMPLATE = "http://api.weatherbit.io/v2.0/forecast/daily?";
    ...
    public WeatherbitResponse weatherbitResponse(City city){
        String requestUrl = API_URL_TEMPLATE + city.name() + API_KEY;
